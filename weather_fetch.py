...
def get_weather_by_coordinates(lat, lon, start_hour=10, end_hour=15):
    ...
    if response.status_code == 200:
        ...
        default_photo = "link to default photo"
